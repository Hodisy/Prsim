...
## Authored scenario takes

| # | Directory | Shopper | Experience |
| --- | --- | --- | --- |
| 01 | `ryan` | Ryan | Ryanair, Dublin, budget and under-seat fit |
| 02 | `sophie` | Sophie | Birthday gift, delivery and exchange |
| 03 | `thomas` | Thomas | Eurostar business and material proof |
| 04 | `lucia` | Lucia | South America, capacity and resistance |
| 05 | `marc` | Marc | Italian rail, weight and comfort |
| 06 | `emma` | Emma | Erasmus easyJet and value comparison |
| 07 | `hugo` | Hugo | Japan visual travel journal |
| 08 | `chloe` | Chloé | Cycling gift and rain reassurance |
| 09 | `nicolas` | Nicolas | Iceland photography protection |
| 10 | `amina` | Amina | Family airport and immediate access |
| 11 | `paul` | Paul | Analytical proof and test protocols |
| 12 | `lea` | Léa | Barcelona visual projection |
| 13 | `daniel` | Daniel | US travel, warranty and trust |
| 14 | `maya` | Maya | Digital nomad work and tropical climate |
| 15 | `kevin` | Kevin | Departure tomorrow and delivery certainty |
| 16 | `atelier` | Atelier | Explicit DIY easter egg |
| 17 | `julien` | Julien | Long cycling commute |
| 18 | `nora` | Nora | Office plus sport |
