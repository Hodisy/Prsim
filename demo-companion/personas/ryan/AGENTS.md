...
- First name: Ryan
- Age group: 18–24
- Current trip: three days in Dublin on Ryanair
- Fare constraint: personal item / under-seat format
- Maximum budget: 100 EUR
- Preferred color: black
- Main priority: verified cabin compatibility, then price
- Decision style: rational and concise
